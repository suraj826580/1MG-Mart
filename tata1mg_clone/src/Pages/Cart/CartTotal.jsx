...
export const CartTotal = () => {
    ...
    const handlePrice = () => {
        const Price = cartList.reduce(
          (accumulator, currentItem) => accumulator + currentItem.actual_price * Number(currentItem.quantity),
          0
        );
        const Discount = cartList.reduce(
          (accumulator, currentItem) => accumulator + (currentItem.actual_price -currentItem.price)* Number(currentItem.quantity),
          0
        );
        setPrice(Price);
