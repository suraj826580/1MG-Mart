  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose} size={"xl" * 1.5}>
        <ModalOverlay />
        <ModalContent
          style={{ height: "470px", width: "70%", verticalalign: "middle" }}>
            ...
            <Box style={{ display: "flex", width: "100%" }}>
              ...
              {login && signup ? (
                <Box
                  ...
                  <Text style={{ marginTop: "5px" }} fontSize={14}>
                    Get access to your orders, lab tests & doctor consultation
                  </Text>
                  ...
                  <Box
                    ...
                    <Box
                      ...
                      {" "}
                      <Text marginTop={"10px"} fontSize={15}>
                        New on 1mg?
                      </Text>
                      <Text
                        marginTop={"10px"}
                ...
                <Box
                  ...
                  <div>
                    <Box
                      ...
                      marginLeft={"20%"}
                      marginTop="30px">
                      <Text color="#F1694B" fontWeight={500} fontSize={15}>
                        Get OTP on SMS |
                      </Text>
                      <Text color="#F1694B" fontWeight={500} fontSize={15}>
                        Get OTP on Call
